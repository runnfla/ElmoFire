...
1\. Download the `GaleFuncs-<version>.oxt` file from the [Releases page](https://github.com/runnfla/GaleFuncs/releases) or from the official [LibreOffice Extensions & Templates Repository](https://extensions.libreoffice.org/en/extensions/show/99599)\
...
1\. Download the `GaleFuncs-<version>-Excel.zip` archive from the [Releases page](https://github.com/runnfla/GaleFuncs/releases)\
